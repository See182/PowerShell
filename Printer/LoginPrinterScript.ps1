function Get-PrinterScript {
    ...
    #Check to see if the log directory exists and create it it doesn't yet exist.
        ...
        $LogPathExist=Test-Path C:
        if ($LogPathExist) {
               write-host "C Drive Exists"
        } else {
            write-host "C Drive not Mapped"
            return
        }
